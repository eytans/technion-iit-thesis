...
Currently, theory exploration still faces challenges when trying to fulfill all three goals at once:\SI{these are not phrased as "goals"; either change the word or rephrase}
\begin{itemize}
