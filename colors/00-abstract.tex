...
Essentially, each e-graph represents an equivalence relation, and each branch corresponds to a matching coarsened equivalence relation.
Based on this observation, we present an extension to e-graphs, called \emph{Colored E-Graphs}, as a way to efficiently represent all of the coarsened equivalence relations in a single structure.
