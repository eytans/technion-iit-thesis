...
Interest in exploratory reasoning in the context of functional calculi started with IsaCoSy~\cite{JAR2010:Johansson}, a system for lemma discovery based in part on CEGIS~\cite{ASPLOS2006/Solar-Lezama}.
...
Speculate~\cite{DBLP:conf/haskell/BraquehaisR17}
