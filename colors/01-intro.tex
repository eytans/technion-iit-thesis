...
Possible uses include selecting the best equivalent of an expression according to some desired metric, such as run-time efficiency~\cite{POPL2009:Tate}, size~\cite{DBLP:conf/fmcad/FlattCWTP22,DBLP:conf/fmcad/NotzliBNPRBT22}, or precision~\cite{herbie}
